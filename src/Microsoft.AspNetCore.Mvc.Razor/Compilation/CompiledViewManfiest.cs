...
namespace Microsoft.AspNetCore.Mvc.Razor.Compilation
{
    public static class CompiledViewManfiest
    {
        ...
        public static TManifest LoadManifest<TManifest>(AssemblyPart assemblyPart, string typeName)
            where TManifest : class
        {
            ...
            var type = Type.GetType($"{typeName},{precompiledAssemblyName}");
            if (type == null)
            {
                return null;
            }

            return (TManifest)Activator.CreateInstance(type);
        }
